...
New in 9.4:
    In order to explore the informational capacity of the small SNN, I am going 
    to task the evolution to choose for SNNs that can learn to switch from 
    state 1 to state 2 and then later back to state 1 (or, alternatively, to 
    state 3).
"""
